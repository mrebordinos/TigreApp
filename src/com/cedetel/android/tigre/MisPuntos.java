...
// 	MUESTRA UNA LISTA DE TODOS LOS PUNTOS DE INTERES AÑADIDOS

public class MisPuntos extends ListActivity {
    ...
    private void fillData() {
        Cursor puntosCursor = mDbHelper.fetchAllIpuntos();
...
//            return true;
        case DELETE_ID:
        	new AlertDialog.Builder(MisPuntos.this)
