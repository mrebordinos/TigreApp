...
import com.cedetel.android.tigre.MisRutas;
import com.cedetel.android.tigre.R;
import com.cedetel.android.tigre.db.FotoDB;


public class MisFotos extends ListActivity {
...
//    private static final int SHOW_PHOTO = Menu.FIRST + 2;
    private static final int OUT_PHOTO = Menu.FIRST + 3;
    private static final int EDIT_PHOTO = Menu.FIRST + 4;
...
//        Cursor mCursor = mDbHelper.fetchAllPhotos();
//        startManagingCursor(mCursor);
//        
//        ListAdapter adapter = new SpotListAdapter(this, mCursor);
...
//        menu.add(0, SHOW_PHOTO, R.string.menu3foto, R.drawable.tomar);
        menu.add(0, OUT_PHOTO, R.string.menu4foto, R.drawable.camera);
...
//            return true;
        case OUT_PHOTO:
        	...
        	intent2.putExtra(FotoDB.KEY_ROWID, 0);
        ...
        case DELETE_ID:
        	...
        	new AlertDialog.Builder(MisFotos.this)
